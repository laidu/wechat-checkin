    ...
    public static String getJson(Object javaBean) {
        ...
        if (null != javaBean) {
            ...
            try {
                ...
                json = g.toJson(clone,javaBean.getClass());
...
//        Gson gson = new Gson();
//        Bankca responseDTO = new ResponseDTO();
//        responseDTO.setName("自傲费金童");
//        responseDTO.setVin("asdasdas");
//        responseDTO.setForceExpireDate("asdadasdasd");
//
//        System.out.println(SensitiveInfoUtils.getJson(responseDTO));
